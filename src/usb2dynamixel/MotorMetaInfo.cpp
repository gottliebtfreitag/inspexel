...
auto getLayoutProInfos() -> std::map<pro::Register, LayoutField> const& {
	...
	static std::map<pro::Register, LayoutField> data {
		{pro::Register::MODEL_NUMBER           , {2, true,  A:: R, "model_number"           , "model_number"           }},
		{pro::Register::MODEL_INFORMATION      , {4, true,  A:: R, "model_information"      , "model_information"      }},
		{pro::Register::FIRMWARE_VERSION       , {1, true,  A:: R, "firmware_version"       , "firmware_version"       }},
		{pro::Register::ID                     , {1, true,  A::RW, "id"                     , "id"                     }},
		{pro::Register::BAUD_RATE              , {1, true,  A::RW, "baud_rate"              , "baud_rate"              }},
		{pro::Register::RETURN_DELAY_TIME      , {1, true,  A::RW, "return_delay_time"      , "return_delay_time"      }},
		{pro::Register::OPERATING_MODE         , {1, true,  A::RW, "operating_mode"         , "operating_mode"         }},
		{pro::Register::HOMING_OFFSET          , {4, true,  A::RW, "homing_offset"          , "homing_offset"          }},
		{pro::Register::MOVING_THRESHOLD       , {4, true,  A::RW, "moving_threshold"       , "moving_threshold"       }},
		{pro::Register::TEMPERATURE_LIMIT      , {1, true,  A::RW, "temperature_limit"      , "temperature_limit"      }},
		{pro::Register::MAX_VOLTAGE_LIMIT      , {2, true,  A::RW, "max_voltage_limit"      , "max_voltage_limit"      }},
		{pro::Register::MIN_VOLTAGE_LIMIT      , {2, true,  A::RW, "min_voltage_limit"      , "min_voltage_limit"      }},
		{pro::Register::ACCELERATION_LIMIT     , {4, true,  A::RW, "acceleration_limit"     , "acceleration_limit"     }},
		{pro::Register::TORQUE_LIMIT           , {2, true,  A::RW, "torque_limit"           , "torque_limit"           }},
		{pro::Register::VELOCITY_LIMIT         , {4, true,  A::RW, "velocity_limit"         , "velocity_limit"         }},
		{pro::Register::MAX_POSITION_LIMIT     , {4, true,  A::RW, "max_position_limit"     , "max_position_limit"     }},
		{pro::Register::MIN_POSITION_LIMIT     , {4, true,  A::RW, "min_position_limit"     , "min_position_limit"     }},
		{pro::Register::EXTERNAL_PORT_MODE_1   , {1, true,  A::RW, "external_port_mode_1"   , "external_port_mode_1"   }},
		{pro::Register::EXTERNAL_PORT_MODE_2   , {1, true,  A::RW, "external_port_mode_2"   , "external_port_mode_2"   }},
		{pro::Register::EXTERNAL_PORT_MODE_3   , {1, true,  A::RW, "external_port_mode_3"   , "external_port_mode_3"   }},
		{pro::Register::EXTERNAL_PORT_MODE_4   , {1, true,  A::RW, "external_port_mode_4"   , "external_port_mode_4"   }},
		{pro::Register::SHUTDOWN               , {1, true,  A::RW, "shutdown"               , "shutdown"               }},
		{pro::Register::TORQUE_ENABLE          , {1, false, A::RW, "torque_enable"          , "torque_enable"          }},
		{pro::Register::LED_RED                , {1, false, A::RW, "led_red"                , "led_red"                }},
		{pro::Register::LED_GREEN              , {1, false, A::RW, "led_green"              , "led_green"              }},
		{pro::Register::LED_BLUE               , {1, false, A::RW, "led_blue"               , "led_blue"               }},
		{pro::Register::VELOCITY_I_GAIN        , {2, false, A::RW, "velocity_i_gain"        , "velocity_i_gain"        }},
		{pro::Register::VELOCITY_P_GAIN        , {2, false, A::RW, "velocity_p_gain"        , "velocity_p_gain"        }},
		{pro::Register::POSITION_P_GAIN        , {2, false, A::RW, "position_p_gain"        , "position_p_gain"        }},
		{pro::Register::GOAL_POSITION          , {4, false, A::RW, "goal_position"          , "goal_position"          }},
		{pro::Register::GOAL_VELOCITY          , {4, false, A::RW, "goal_velocity"          , "goal_velocity"          }},
		{pro::Register::GOAL_TORQUE            , {2, false, A::RW, "goal_torque"            , "goal_torque"            }},
		{pro::Register::GOAL_ACCELERATION      , {4, false, A::RW, "goal_acceleration"      , "goal_acceleration"      }},
		{pro::Register::MOVING                 , {1, false, A:: R, "moving"                 , "moving"                 }},
		{pro::Register::PRESENT_POSITION       , {4, false, A:: R, "present_position"       , "present_position"       }},
		{pro::Register::PRESENT_VELOCITY       , {4, false, A:: R, "present_velocity"       , "present_velocity"       }},
		{pro::Register::PRESENT_CURRENT        , {2, false, A:: R, "present_current"        , "present_current"        }},
		{pro::Register::PRESENT_INPUT_VOLTAGE  , {2, false, A:: R, "present_input_voltage"  , "present_input_voltage"  }},
		{pro::Register::PRESENT_TEMPERATURE    , {1, false, A:: R, "present_temperature"    , "present_temperature"    }},
		{pro::Register::EXTERNAL_PORT_DATA_1   , {2, false, A::RW, "external_port_data_1"   , "external_port_data_1"   }},
		{pro::Register::EXTERNAL_PORT_DATA_2   , {2, false, A::RW, "external_port_data_2"   , "external_port_data_2"   }},
		{pro::Register::EXTERNAL_PORT_DATA_3   , {2, false, A::RW, "external_port_data_3"   , "external_port_data_3"   }},
		{pro::Register::EXTERNAL_PORT_DATA_4   , {2, false, A::RW, "external_port_data_4"   , "external_port_data_4"   }},
		{pro::Register::REGISTERED_INSTRUCTION , {1, false, A:: R, "registered_instruction" , "registered_instruction" }},
		{pro::Register::STATUS_RETURN_LEVEL    , {1, false, A::RW, "status_return_level"    , "status_return_level"    }},
		{pro::Register::HARDWARE_ERROR_STATUS  , {1, false, A:: R, "hardware_error_status"  , "hardware_error_status"  }},
	};
	return data;
}
